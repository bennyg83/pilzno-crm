...
import { Dashboard, People, Person, Event, MonetizationOn, Logout } from '@mui/icons-material'
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { text: 'Donations', icon: <MonetizationOn />, path: '/donations', available: false, phase: 'Phase 3' },
  ]
